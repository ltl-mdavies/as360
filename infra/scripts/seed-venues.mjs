...
const variants = [
  {
    ...
    venueId: "venue_penn_station",
    mediaVariantKey: "2-Sheet Poster||46.2||60.2",
    label: "2-Sheet Poster · 46.2\"h × 60.2\"w",
  ...
  {
    entityType: "MediaVariant",
    id: "variant_penn_column_wrap_105_25x124",
    venueId: "venue_penn_station",
    mediaVariantKey: "Column Wrap||105.25||124",
    label: "Column Wrap · 105.25\"h × 124\"w",
  ...
  {
    entityType: "MediaVariant",
    id: "variant_penn_column_wrap_106_5x124",
    venueId: "venue_penn_station",
    mediaVariantKey: "Column Wrap||106.5||124",
    label: "Column Wrap · 106.5\"h × 124\"w",
    mediaType: "Column Wrap",
    color: "#22c55e",
    abbreviation: "CW",
    unitNumber: "NYPENN_CW2",
    updatedAt: now,
  },
  {
    entityType: "MediaVariant",
    ...
    venueId: "venue_penn_station",
    mediaVariantKey: "Stair Riser||138||75",
    label: "Stair Riser · 138\"h × 75\"w",
    mediaType: "Stair Riser",
    color: "#a78bfa",
    abbreviation: "SR",
    unitNumber: "INT-STAIR-RISER",
    updatedAt: now,
  },
  {
    entityType: "MediaVariant",
...
const inventory = [
  makeInventory({
    ...
    mediaVariantKey: "2-Sheet Poster||46.2||60.2",
    variantLabel: "2-Sheet Poster · 46.2\"h × 60.2\"w",
    mediaType: "2-Sheet Poster",
    unitNumber: "2SHEET_46x60_48PT",
    trimHeight: 46.2,
    trimWidth: 60.2,
  ...
  makeInventory({
    ...
    mediaVariantKey: "Column Wrap||105.25||124",
    variantLabel: "Column Wrap · 105.25\"h × 124\"w",
    mediaType: "Column Wrap",
    unitNumber: "NYPENN_CW1",
    trimHeight: 105.25,
    trimWidth: 124,
  ...
  makeInventory({
    ...
    mediaVariantKey: "Column Wrap||106.5||124",
    variantLabel: "Column Wrap · 106.5\"h × 124\"w",
    mediaType: "Column Wrap",
    unitNumber: "NYPENN_CW2",
    trimHeight: 106.5,
    trimWidth: 124,
  ...
  makeInventory({
    ...
    mediaVariantKey: "Stair Riser||138||75",
    variantLabel: "Stair Riser · 138\"h × 75\"w",
    mediaType: "Stair Riser",
    unitNumber: "INT-STAIR-RISER",
    trimHeight: 138,
    trimWidth: 75,
